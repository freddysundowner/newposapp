...
class CashOutLayout extends StatelessWidget {
  ...
  Widget inputFields(context) {
   ...
   saveFunction({required BuildContext context}) {
     ...
     isSmallScreen(context)?  showSnackBar(message: "please fill all fields", color: Colors.black):generalAlert(title: "Error", message:"please fill all fields");
     } else {
