...
Widget WalletCard(
  ...
  return InkWell(
    onTap: () {
      if (type == "deposit") {
        showBottomSheetUsage(depositBody, context, uid, customer);
      } else {
        showBottomSheetUsage(depositBody, context, uid, customer);
      }
    },
...
showBottomSheet(DepositModel depositBody, context, uid) {
  WalletController walletController = Get.find<WalletController>();
  return showModalBottomSheet<void>(
      context: context,
      builder: (BuildContext context) {
...
showBottomSheetUsage(DepositModel depositBody, context, uid, customer) {
  WalletController walletController = Get.find<WalletController>();
  AttendantController attendantController = Get.find<AttendantController>();
  return showModalBottomSheet<void>(
      context: context,
