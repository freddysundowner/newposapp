...
import 'package:flutterpos/screens/sales/components/product_select.dart';
...
class CreateSale extends StatelessWidget {
  CreateSale({Key? key}) : super(key: key) {
    customersController
        .getCustomersInShop(createShopController.currentShop.value?.id);
  }
                    ...
                    : productController.products.length == 0
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return shopcard(
                                  product: productModel, type: "sales");
                            });
              },
            ),
          )),
            ...
            body: Column(
              ...
              children: [
                ...
                Obx(() {
                  return salesController.selectedList.length == 0
                      ? Container(height: 0)
                      : salesController.saveSaleLoad.value
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      TextFormField(
                                                                        ...
                                                                        onChanged:
                                                                          ...
                                                                          if (int.parse(value) >
                                                                              salesController.grandTotal.value) {
                                                                            salesController.textEditingCredit.text =
                                                                                salesController.grandTotal.value.toString();
                                                                            salesController.balance.value =
                                                                                0;
                                                                          } else if (salesController.textEditingCredit.text ==
                                                                              "") {
                                                                            salesController.balance.value =
                                                                                salesController.grandTotal.value;
                                                                          } else {
                                                                            salesController.balance.value =
                                                                                salesController.grandTotal.value - int.parse(value);
                                                                          }
                                                                        },
