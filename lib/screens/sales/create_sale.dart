...
class CreateSale extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    customersController.getCustomerById(createShopController.currentShop.value?.id);
      ...
      bottomNavigationBar: Obx(() {
        return BottomAppBar(
          ...
          child: salesController.selectedList.length == 0
            ...
            child: salesController.saveSaleLoad.value?Center(child: CircularProgressIndicator()):
            InkWell(
              splashColor: Colors.transparent,
              onTap: () {
                if (salesController.selectedList.length == 0) {
                  ScaffoldMessenger.of(context).showSnackBar(new SnackBar(
                      content: Text("Please select products to sell")));
                } else {
                  showDialog(
                      context: context,
                      builder: (_) {
                                                    ...
                                                    List.generate(
                                                        customersController
                                                            ...
                                                            SimpleDialogOption(
                                                              onPressed:
                                                                  () {
                                                                salesController.selectedCustomer.value = customersController
                                                                    .customers
                                                                    .elementAt(index)
                                                                    .name!;
                                                                salesController.selectedCustomerId.value = customersController
                                                                    .customers
                                                                    .elementAt(index)
                                                                    .id!;
                                                                Navigator.pop(
                                                              ...
                                                              child: Text(
                                                                  "${customersController.customers.elementAt(index).name}"),
                                                            )),
                                                  );
                                                });
                                          }
