                      ...
                      onTap: () {
                        if (purchaseController.selectedList.length == 0) {
                          ScaffoldMessenger.of(context).showSnackBar(
                              new SnackBar(
                                  content:
                                      Text("Please select products to sell")));
                        } else {
                          showDialog(
                              context: context,
                              builder: (_) {
                                return Container(
                                  ...
                                  child: AlertDialog(
                                    title:
                                        Center(child: Text("Confirm Stock In")),
                                    content: Container(
                                      height:
                                                                  ...
                                                                  List.generate(
                                                                      ...
                                                                      (index) =>
                                                                          SimpleDialogOption(
                                                                            onPressed:
                                                                                () {
                                                                              purchaseController.selectedSupplier.value = supplierController.suppliers.elementAt(index).fullName!;
                                                                              purchaseController.selectedSupplierId.value = supplierController.suppliers.elementAt(index).id!;
